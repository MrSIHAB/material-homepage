...
*/
    ...
    ea("WeakMap", function(a) {
        ...
        g.prototype.has = function(l) {
            return c(l) && ra(l, f) && ra(l[f], this.R)
        }
        ;
    ...
    ea("Map", function(a) {
        ...
        c.prototype.delete = function(g) {
            ...
            g.list.length || delete this.m[g.id],
    ...
    var x = function(a, b, c) {
      ...
      , La = function(a, b, c) {
        xa(a) || Ha("Expected object but got %s: %s.", [va(a), a], b, Array.prototype.slice.call(arguments, 2));
        return a
    }
      , Ma = function(a, b, c) {
    ...
    ;
    var ib = function(a) {
        if (a instanceof hb && a.constructor === hb && a.m === gb)
            return a.g;
      ...
      , Yb = function(a) {
        ...
        return a.replace(ac, function(d, e) {
            ...
            if (!f) {
                ...
                if (c.tagName && Vb[c.tagName.toUpperCase()])
    ...
    hc.prototype.remove = function(a) {
        ic(this);
        a = String(a);
        return this.g.has(a) ? (this.s = null,
        this.m = Ja(this.m) - this.g.get(a).length,
        this.g.delete(a)) : !1
    }
    ;
    ...
    k.oa = function(a) {
        ...
        var b = [];
        if ("string" === typeof a)
            jc(this, a) && (b = b.concat(this.g.get(String(a))));
        else {
...
*/
    ...
    ;
    var tc = new sc("OFF",Infinity), uc = new sc("SEVERE",1E3), vc = new sc("WARNING",900), wc = new sc("CONFIG",700), xc = new sc("FINE",500), yc = function() {
        this.clear()
    }, zc;
    ...
    var fd = Lb(), B = Kb() ? !1 : z("Trident") || z("MSIE"), gd = z("Edge"), hd = gd || B, C = z("Gecko") && !(-1 != Gb().toLowerCase().indexOf("webkit") && !z("Edge")) && !(z("Trident") || z("MSIE")) && !z("Edge"), id = -1 != Gb().toLowerCase().indexOf("webkit") && !z("Edge"), jd = cd(), kd = $c() ? "Windows" === Hb.platform : z("Windows"), ld = $c() ? "Android" === Hb.platform : z("Android"), md = ad(), nd = z("iPad"), od = z("iPod"), pd = bd(), qd = function() {
        var a = q.document;
    ...
    var zd = function(a) {
      ...
      , Ed = {}
      , Fd = function(a, b) {
        return a && b && a.yc && b.yc ? a.qa !== b.qa ? !1 : a.toString() === b.toString() : a instanceof Wc && b instanceof Wc ? a.qa != b.qa ? !1 : a.toString() == b.toString() : a == b
    }
      , Jd = function(a) {
        if (Zc(a, Uc, Xc)) {
            var b = String;
    ...
    var Sd = function(a) {
      ...
      , Wd = function(a, b) {
        ...
        if (c.getElementsByClassName)
            ...
            c = document;
            var d = b || c;
            a = d.querySelectorAll && d.querySelector && a ? d.querySelector(a ? "." + a : "") : Ud(c, a, b)[0] || null
        }
        return a || null
    }
      , Ud = function(a, b, c) {
      ...
      , ae = function(a) {
        var b = Zd(a);
        a = $d(a);
        return B && a.pageYOffset != b.scrollTop ? new D(b.scrollLeft,b.scrollTop) : new D(a.pageXOffset || b.scrollLeft,a.pageYOffset || b.scrollTop)
    }
      , Zd = function(a) {
      ...
      , ne = function(a, b, c) {
        if (!(a.nodeName in je))
            ...
            else if (a.nodeName in ke)
                b.push(ke[a.nodeName]);
            else
...
*/
    function qe(a, b) {
        ...
        c = c.popup;
        Ld();
        if (Ed["extension.translation"])
            b = Ed["extension.translation"]({
                query: d,
                kc: e,
                fc: f,
                ic: h,
            ...
            if (d)
                if (e) {
                    ...
                    l += '</select></div><div class="gtx-source-audio"><div class="jfk-button-img"></div></div><div class="gtx-body">' + Dd(d) + '</div><br><div class="gtx-language">' + Dd(h) + '</div><div class="gtx-target-audio"><div class="jfk-button-img"></div></div><div class="gtx-body">' + Dd(e) + "</div>";
                    if (b) {
                    ...
                    l += "No translation results for <b>" + Dd(d) + "</b>.";
            b = Ad(l)
        }
        b && b.m && a ? b.m(a) : (b = se(b),
        Xb(x(a), b))
    }
    function se(a) {
        if (!xa(a))
    ...
    k.translate = function(a, b) {
        a instanceof D ? (this.left += a.x,
        this.right += a.x,
        this.top += a.y,
        this.bottom += a.y) : (Ja(a),
        this.left += a,
        this.right += a,
    ...
    var Ve = function(a, b) {
      ...
      , af = function(a) {
        for (var b = new Te(0,Infinity,Infinity,0), c = Sd(a), d = c.g.body, e = c.g.documentElement, f = Zd(c.g); a = Ze(a); )
            if (!(B && 0 == a.clientWidth || id && 0 == a.clientHeight && a == d) && a != d && a != e && "visible" != Ve(a, "overflow")) {
                var h = $e(a)
      ...
      , ef = function(a) {
        var b = a.offsetWidth
          , c = a.offsetHeight
          , d = id && !b && !c;
        return (void 0 === b || d) && a.getBoundingClientRect ? (a = Ye(a),
        new Pd(a.right - a.left,a.bottom - a.top)) : new Pd(b,c)
    }
      , gf = function(a) {
        var b = $e(a);
        a = ff(a);
    ...
    var lf = function() {
        ...
        return jd ? (a = /1[0|1][_.][0-9_.]+/,
        (a = a.exec(Gb())) ? a[0].replace(/_/g, ".") : "10") : ld ? (a = /Android\s+([^\);]+)(\)|;)/,
        (a = a.exec(Gb())) ? a[1] : "") : md || nd || od ? (a = /(?:iPhone|CPU)\s+OS\s+(\S+)/,
        (a = a.exec(Gb())) ? a[1].replace(/_/g, ".") : "") : ""
    }();
    var mf = function(a) {
      ...
      , nf = function() {
        ...
        if (Ae && !bd())
            return mf(/Version\/([0-9.]+)/);
        if (ve || xe) {
            if (a = /Version\/(\S+).*Mobile\/(\S+)/.exec(Gb()))
                return a[1] + "." + a[2]
        } else if (ye)
            return (a = mf(/Android\s+([0-9.]+)/)) ? a : mf(/Version\/([0-9.]+)/);
        return ""
    }();
    var of = function(a, b) {
    ...
    var qf = function(a, b, c, d, e, f) {
        if (a.m) {
            ...
            if (p = af(g))
                g = gf(g),
                g = new Te(g.top,g.left + g.width,g.top + g.height,g.left),
                rf(b) ? g.top < p.top && !(n & 1) ? l -= p.top - g.top : g.bottom > p.bottom && n & 1 && (l -= g.bottom - p.bottom) : g.left < p.left && !(n & 4) ? l -= p.left - g.left : g.right > p.right && n & 4 && (l -= g.right - p.right);
            ...
            v = gf(g);
            if (G = af(g))
                P = new Ue(G.left,G.top,G.right - G.left,G.bottom - G.top),
                G = Math.max(v.left, P.left),
                M = Math.min(v.left + v.width, P.left + P.width),
                G <= M && (K = Math.max(v.top, P.top),
                P = Math.min(v.top + v.height, P.top + P.height),
                K <= P && (v.left = G,
                v.top = K,
                v.width = M - G,
                v.height = P - K));
            ...
            F = 0;
            if (f || 0 != r)
                r & 4 ? p.x -= g.width + (f ? f.right : 0) : r & 2 ? p.x -= g.width / 2 : f && (p.x += f.left),
                r & 1 ? p.y -= g.height + (f ? f.bottom : 0) : f && (p.y += f.top);
            n && (y ? (r = p,
            F = g,
            v = 0,
            65 == (n & 65) && (r.x < y.left || r.x >= y.right) && (n &= -2),
            132 == (n & 132) && (r.y < y.top || r.y >= y.bottom) && (n &= -5),
            r.x < y.left && n & 1 && (r.x = y.left,
            v |= 1),
            n & 16 && (G = r.x,
            r.x < y.left && (r.x = y.left,
            v |= 4),
            r.x + F.width > y.right && (F.width = Math.min(y.right - r.x, G + F.width - y.left),
            F.width = Math.max(F.width, 0),
            v |= 4)),
            r.x + F.width > y.right && n & 1 && (r.x = Math.max(y.right - F.width, y.left),
            v |= 1),
            n & 2 && (v |= (r.x < y.left ? 16 : 0) | (r.x + F.width > y.right ? 32 : 0)),
            r.y < y.top && n & 4 && (r.y = y.top,
            v |= 2),
            n & 32 && (G = r.y,
            r.y < y.top && (r.y = y.top,
            v |= 8),
            r.y + F.height > y.bottom && (F.height = Math.min(y.bottom - r.y, G + F.height - y.top),
            F.height = Math.max(F.height, 0),
            v |= 8)),
            r.y + F.height > y.bottom && n & 4 && (r.y = Math.max(y.bottom - F.height, y.top),
            v |= 2),
            n & 8 && (v |= (r.y < y.top ? 64 : 0) | (r.y + F.height > y.bottom ? 128 : 0)),
            y = v) : y = 256,
            F = y);
            n = new Ue(0,0,0,0);
            n.left = p.x;
            ...
            n.height = g.height;
            y = F;
            y & 496 || (Xe(l, new D(n.left,n.top)),
            g = new Pd(n.width,n.height),
            h == g || h && g && h.width == g.width && h.height == g.height || (h = g,
            l = l.style,
            C ? l.MozBoxSizing = "border-box" : id ? l.WebkitBoxSizing = "border-box" : l.boxSizing = "border-box",
            ...
            !a.H || y & 496 || (e = parseFloat(a.g.style.left),
            f = parseFloat(a.g.style.top),
            x(!isNaN(e) && !isNaN(f), "Could not parse position."),
            isFinite(e) && 0 == e % 1 && isFinite(f) && 0 == f % 1 || Xe(a.g, Math.round(e), Math.round(f)))
        }
        tf(a, b, c, d)
    }
      , tf = function(a, b, c, d) {
        ...
        a.m ? (c = cf(a.m, a.g),
        d = uf(a.m, b),
        rf(b) ? e.style.top = vf(c.y + d.y, a.g.offsetHeight - 15) + "px" : e.style.left = vf(c.x + d.x, a.g.offsetWidth - 15) + "px") : e.style[0 == c ? rf(b) ? "top" : "left" : rf(b) ? "bottom" : "right"] = d + "px"
    }
      , vf = function(a, b) {
    ...
    var zf = "combobox grid group listbox menu menubar radiogroup row rowgroup tablist textbox toolbar tree treegrid".split(" ")
      , Af = function(a, b) {
        b ? (x(ab(yf, b), "No such ARIA role " + b),
    ...
    var Mf = function(a, b) {
        ...
        if (a) {
            ...
            this.m = b;
            (b = a.relatedTarget) ? C && (ed(b, "nodeName") || (b = null)) : "mouseover" == c ? b = a.fromElement : "mouseout" == c && (b = a.toElement);
    ...
    Sf.prototype.add = function(a, b, c, d, e) {
        ...
        var h = Tf(a, b, d, e);
        -1 < h ? (b = a[h],
        c || (b.Wa = !1)) : (b = new Qf(b,this.src,f,!!d,e),
        b.Wa = c,
        a.push(b));
        return b
    }
    ...
    var Vf = function(a, b, c, d, e) {
      ...
      , Tf = function(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.removed && f.listener == b && f.capture == !!c && f.cb == d)
                return e
        }
        return -1
    };
    var Wf = "closure_lm_" + (1E6 * Math.random() | 0)
      ...
      , Zf = function(a, b, c, d, e) {
        ...
        c = ag(c);
        return Of(a) ? a.s.add(String(b), c, !0, xa(d) ? !!d.capture : !!d, e) : bg(a, b, c, !0, d, e)
    }
      , gg = function(a, b, c, d, e) {
        if (Array.isArray(b))
            ...
            d = xa(d) ? !!d.capture : !!d,
            c = ag(c),
            Of(a) ? a.s.remove(String(b), c, d, e) : a && (a = cg(a)) && (b = Vf(a, b, c, d, e)) && hg(b)
    }
      , hg = function(a) {
        if ("number" !== typeof a && a && !a.removed) {
            ...
            if (Of(b))
                ...
                var c = a.type
                  , d = a.proxy;
                b.removeEventListener ? b.removeEventListener(c, d, a.capture) : b.detachEvent ? b.detachEvent(eg(c), d) : b.addListener && b.removeListener && b.removeListener(d);
                Yf--;
                (c = cg(b)) ? (Uf(c, a),
                0 == c.m && (c.src = null,
                b[Wf] = null)) : Rf(a)
    ...
    var I = function(a, b) {
        ...
        if (c) {
            var d = [];
            for (var e = 1; c; c = c.Ba)
                d.push(c),
                x(1E3 > ++e, "infinite loop")
        }
        a = a.pc;
        c = b.type || b;
        "string" === typeof b ? b = new Jf(b,a) : b instanceof Jf ? b.target = b.target || a : (e = b,
        b = new Jf(c,a),
        cb(b, e));
        e = !0;
        if (d)
    ...
    og.prototype.listen = function(a, b, c, d) {
        Array.isArray(b) || (b && (pg[0] = b.toString()),
        b = pg);
    ...
    var qg = function(a, b, c, d, e, f) {
        if (Array.isArray(c))
            ...
            d = ag(d),
            e = !!e,
            c = Of(b) ? Vf(b.s, String(c), d, e, f) : b ? (b = cg(b)) ? Vf(b, c, d, e, f) : null : null,
            c && (hg(c),
            delete a.B[c.key]);
        return a
    };
    ...
    function ug(a, b) {
        if (b instanceof vb)
            b instanceof vb && b.constructor === vb ? b = b.g : (Ia("expected object of type SafeUrl, got '" + b + "' of type " + va(b)),
    ...
    wg.prototype.Ba = function(a) {
        Wa(a, t(function(b) {
            var c = Df(b.target);
            c && "aria-activedescendant" == b.attributeName && (this.s = c,
            zg(this))
        }, this))
    }
    ;
    ...
    wg.prototype.pa = function() {
        if (!this.s)
            ...
            var a = pe(this.s, function(g) {
              ...
              , b = !1;
            this.m && this.m != a && (Ag(this),
            this.F = this.m = null,
            b = !0);
            if (!this.m && a && (this.m = a,
            !(a.getAttribute("data-tooltip-only-on-overflow") && a.offsetWidth >= a.scrollWidth && a.offsetHeight >= a.scrollHeight || this.ka && "mouse" == a.getAttribute("data-tooltip-trigger")))) {
                var c = Tb;
                if (a.getAttribute("data-tooltip-contained"))
                    ...
                    c = a.g ? a.g : Sb(a.getAttribute("data-tooltip"));
    ...
    wg.prototype.Y = function(a, b, c, d, e, f) {
        ...
        this.M != e && (this.M && !jb(bc(this.M)) && Qe(this.g.D(), this.M),
        jb(bc(e)) || Oe(this.g.D(), e),
        this.M = e);
        Xe(this.g.D(), 0, 0);
        if (b instanceof A) {
            d = this.g.g;
            if (void 0 !== d.tagName) {
                ...
                if ("style" === d.tagName.toLowerCase())
                    throw Error("Use safeStyleEl.setTextContent with a SafeStyleSheet.");
            }
            d.innerHTML = Pb(b)
        } else
            for (fe(this.g.g); d = b.firstChild; )
                this.g.g.appendChild(d);
        this.u.m = a;
        this.u.F()
    }
    ;
    ...
    var Gg = function(a, b, c, d, e, f) {
      ...
      , Eg = function(a) {
        if (48 <= a && 57 >= a || 96 <= a && 106 >= a || 65 <= a && 90 >= a || (id || gd) && 0 == a)
            return !0;
        switch (a) {
        case 32:
        case 43:
    ...
    k.uc = function(a) {
        if (id || gd)
            if (17 == this.S && !a.ctrlKey || 18 == this.S && !a.altKey || jd && 91 == this.S && !a.metaKey)
                this.ia = this.S = -1;
        -1 == this.S && (a.ctrlKey && 17 != a.keyCode ? this.S = 17 : a.altKey && 18 != a.keyCode ? this.S = 18 : a.metaKey && 91 != a.keyCode && (this.S = 91));
        Gg(a.keyCode, this.S, a.shiftKey, a.ctrlKey, a.altKey, a.metaKey) ? (this.ia = Fg(a.keyCode),
        Mg && (this.rb = a.altKey)) : this.handleEvent(a)
    }
    ;
    k.wc = function(a) {
        this.ia = this.S = -1;
    ...
    k.handleEvent = function(a) {
        ...
        if (B && "keypress" == a.type) {
            ...
            (id || gd) && "keypress" == a.type ? (d = this.ia,
            e = 0 <= b.charCode && 63232 > b.charCode && Eg(d) ? b.charCode : 0) : ("keypress" == a.type ? (Mg && (c = this.rb),
            b.keyCode == b.charCode ? 32 > b.keyCode ? (d = b.keyCode,
            e = 0) : (d = this.ia,
            e = b.charCode) : (d = b.keyCode || this.ia,
            e = b.charCode || 0)) : (d = b.keyCode || this.ia,
            e = b.charCode || 0),
            jd && 63 == e && 224 == d && (d = 191));
        var f = d = Fg(d);
        d ? 63232 <= d && d in Kg ? f = Kg[d] : 25 == d && a.shiftKey && (f = 9) : b.keyIdentifier && b.keyIdentifier in Lg && (f = Lg[b.keyIdentifier]);
        if (!C || "keypress" != a.type || Gg(f, this.S, a.shiftKey, a.ctrlKey, c, a.metaKey))
            a = f == this.S,
            this.S = f,
            b = new Ig(f,e,a,b),
            b.altKey = c,
    ...
    Xg.prototype.ba = function(a, b) {
        ...
        g.forEach(function(l) {
            f || l != d ? h || l != e ? c |= ch(this, l) : h = !0 : (f = !0,
            e == d && (h = !0));
            1 == ch(this, l) && (Na(b),
            b.hasAttribute("tabindex") && me(b) && le(b, !1))
        }, this);
        a.O = c;
        f || (g.push(d),
        e == d && (h = !0));
    ...
    k.lb = function(a, b) {
        ...
        if (kf) {
            if (c = c ? "none" : "",
            a.style && (a.style[kf] = c),
            b) {
                a = 0;
                for (var d; d = b[a]; a++)
                    d.style && (d.style[kf] = c)
            }
        } else if (B && (c = c ? "on" : "",
    ...
    var lh = function(a) {
      ...
      , mh = function(a, b) {
        b && (a.Z ? Xa(a.Z, b) || a.Z.push(b) : a.Z = [b],
        ah(a, b, !0))
    };
    ...
    J.prototype.ha = function() {
        ...
        this.g.cc(this);
        this.P & -2 && (this.bb && kh(this, !0),
        this.P & 32 && (a = this.D())) && (b = this.K || (this.K = new Jg),
        b.attach(a),
        Tg(this).listen(b, "key", this.vc).listen(a, "focus", this.tc).listen(a, "blur", this.ac))
    }
    ;
    var kh = function(a, b) {
        var c = Tg(a)
          , d = a.D();
        b ? (c.listen(d, hh.ob, a.Pa).listen(d, [hh.pb, hh.Tb], a.Qa).listen(d, "mouseover", a.Ua).listen(d, "mouseout", a.Da),
        a.V != Ua && c.listen(d, "contextmenu", a.V),
        B && !a.N && (a.N = new nh(a),
        Ff(a, u(Ef, a.N)))) : (qg(qg(qg(qg(c, d, hh.ob, a.Pa), d, [hh.pb, hh.Tb], a.Qa), d, "mouseover", a.Ua), d, "mouseout", a.Da),
        a.V != Ua && qg(c, d, "contextmenu", a.V),
        B && (Ef(a.N),
        a.N = null))
    };
    ...
    J.prototype.setEnabled = function(a) {
        var b = this.B;
        b && "function" == typeof b.isEnabled && !b.isEnabled() || !oh(this, 1, !a) || (a || (ph(this, !1),
        qh(this, !1)),
        this.isVisible() && this.g.hb(this, a),
        sh(this, 1, !a, !0))
    }
    ;
    var qh = function(a, b) {
    ...
    var sh = function(a, b, c, d) {
        d || 1 != b ? a.P & b && c != !!(a.O & b) && (a.g.mb(a, b, c),
        a.O = c ? a.O | b : a.O & ~b) : a.setEnabled(!c)
    }
      , th = function(a) {
        if (a.aa && a.O & 32)
            throw Error("Component already rendered");
    ...
    J.prototype.Da = function(a) {
        !uh(a, this.D()) && I(this, "leave") && (L(this, 4) && ph(this, !1),
        L(this, 2) && qh(this, !1))
    }
    ;
    J.prototype.V = Ua;
    ...
    k = J.prototype;
    k.Pa = function(a) {
        this.isEnabled() && (L(this, 2) && qh(this, !0),
        0 != a.g.button || jd && a.ctrlKey || (L(this, 4) && ph(this, !0),
        this.g && this.g.Rb(this) && this.D().focus()));
        0 != a.g.button || jd && a.ctrlKey || a.s()
    }
    ;
    k.Qa = function(a) {
        this.isEnabled() && (L(this, 2) && qh(this, !0),
        this.isActive() && this.Sa(a) && L(this, 4) && ph(this, !1))
    }
    ;
    k.Sa = function(a) {
    ...
    ;
    k.vc = function(a) {
        return this.isVisible() && this.isEnabled() && this.ab(a) ? (a.s(),
        a.B(),
        !0) : !1
    }
    ;
    ...
    if ("function" !== typeof Xg)
        throw Error("Invalid renderer class " + Xg);
    var vh = Aa(J);
    jh[vh] = Xg;
    ...
    k.jb = function(a) {
        ...
        if (b)
            if (this.na) {
                ...
                a ? (a instanceof A ? b.g = a : (b.setAttribute("data-tooltip", a),
                b.g = null),
    ...
    k.setEnabled = function(a) {
        this.isEnabled() != a && (Ch.I.setEnabled.call(this, a),
        Dh(this))
    }
    ;
    k.ib = function(a) {
    ...
    var Eh = function(a, b) {
        a.D() && (a = a.D(),
        b ? Oe(a, "jfk-button-clear-outline") : Qe(a, "jfk-button-clear-outline"))
    }
      , Dh = function(a) {
        a.D() && Fh(a.g, a)
    }
    ...
    Bh.prototype.xa = function(a) {
        ...
        if (Ed["jfk.templates.button.strict"])
            var d = Ed["jfk.templates.button.strict"](c, void 0);
        else {
            c = c || {};
            var e = c.attributes;
            d = c.content;
            ...
            v = v.width;
            Ld();
            if (Ed["jfk.templates.button.classes_"])
                c = Ed["jfk.templates.button.classes_"]({
                    rc: c,
                    disabled: G,
                    checked: F,
                    style: M,
                ...
                c = K += (Fd(v, 1) ? " jfk-button-narrow" : "") + (F ? " jfk-button-checked" : "") + (c ? " " + c : "") + (G ? " jfk-button-disabled" : "")
            }
            f = h + Jd(c) + '"' + (f ? ' aria-disabled="true"' : ' tabindex="' + (g ? Jd(g) : "0") + '"') + (l ? n ? ' data-tooltip="' + Jd(l) + '"' : ' title="' + Jd(l) + '"' : "") + (p ? ' value="' + Jd(p) + '"' : "");
            e ? (Zc(e, Vc, Yc) ? e = e.getContent() : (e = String(e),
            Nd.test(e) || (Ia("Bad value `%s` for |filterHtmlAttributes", [e]),
            e = "zSoyz")),
            Zc(e, Vc, Yc) && (e = e.getContent()),
            e = (e && !e.startsWith(" ") ? " " : "") + e) : e = "";
            d = r(f + e + ">" + Dd(null != d ? d : "") + "</div>")
        }
        r = d;
        d = b || Sd();
        r && r.g ? d = r.g() : (d = de(d.g, "DIV"),
        r = se(r),
        e = r.za(),
        f = e.match(te),
        x(!f, "This template starts with a %s, which cannot be a child of a <div>, as required by soy internals. Consider using goog.soy.renderElement instead.\nTemplate output: %s", f && f[0], e),
        Xb(d, r));
        1 == d.childNodes.length && (r = d.firstChild,
        1 == r.nodeType && (d = r));
        b.oc(d, a.getContent());
        this.ba(a, d);
        return d
    ...
    var Lh = function(a, b, c) {
        var d = c.toLowerCase();
        d in Jh && Kh[Jh[d.toLowerCase()]] >= b.length ? (a.Z && Ya(a.Z, "no-audio") && (0 == a.Z.length && (a.Z = null),
        ah(a, "no-audio", !1)),
        a.Ub = b,
        a.Va = c) : mh(a, "no-audio")
    };
    function Mh(a) {
    ...
    Th.prototype.F = function() {
        this.B();
        for (var a in this.g)
            0 != this.g[a] && (Wh(this, "/gen204?" + Vh(this, a, this.g[a][1])),
            a in this.g && (q.clearTimeout(this.g[a][0]),
            delete this.g[a]))
    }
    ;
    Th.T = function() {
    ...
    N.prototype.send = function(a, b, c, d) {
        ...
        try {
            ii(this),
            0 < this.K && (this.U = ji(this.g),
            Jc(this.m, gi(this, "Will abort after " + this.K + "ms if incomplete, xhr2 " + this.U)),
            this.U ? (this.g.timeout = this.K,
            this.g.ontimeout = t(this.Ca, this)) : this.N = mg(this.Ca, this.K, this)),
            Jc(this.m, gi(this, "Sending request")),
            this.M = !0,
            this.g.send(a),
            this.M = !1
        } catch (h) {
            Jc(this.m, gi(this, "Send error: " + h.message)),
            hi(this, h)
        }
    }
    ;
    ...
    N.prototype.Ca = function() {
        "undefined" != typeof ta && this.g && (this.H = "Timed out after " + this.K + "ms, aborting",
        Jc(this.m, gi(this, this.H)),
        I(this, "timeout"),
        this.abort(8))
    }
    ;
    ...
    N.prototype.abort = function() {
        this.g && this.u && (Jc(this.m, gi(this, "Aborting")),
        this.u = !1,
        this.B = !0,
        this.g.abort(),
        this.B = !1,
    ...
    var mi = function(a) {
        if (a.u && "undefined" != typeof ta)
            if (a.V[1] && 4 == ni(a) && 2 == a.sa())
                Jc(a.m, gi(a, "Local request error detected and ignored"));
            else if (a.M && 4 == ni(a))
                mg(a.na, 0, a);
            else if (I(a, "readystatechange"),
            4 == ni(a)) {
                ...
                try {
                    if (oi(a))
                        ...
                        try {
                            ...
                            Jc(a.m, "Can not get status: " + c.message),
                            b = ""
                        }
                        a.H = b + " [" + a.sa() + "]";
                        ki(a)
    ...
    m(Yi, Wi);
    var $i = function(a) {
        a && a.length ? a = new Yi(Ma(a).slice()) : (Zi || (Zi = new Yi(Vi)),
        a = Zi);
        return a
    };
    ...
    function aj(a, b) {
        var c = Ti(a, b);
        return c instanceof Ni ? (c = Pa(c, Pi),
        Ma(c.g(a, b))) : $i(c)
    }
    function bj(a, b) {
        var c = Ti(a, b);
        c instanceof Oi && (c = Ti(a, b),
        Array.isArray(c) ? c = Ma(c) : c instanceof Oi ? c = Ma(c.g(a, b)) : (x(null == c),
        c = [],
        Si(a, b, c)));
        a = Ma(c);
    ...
    Pl.prototype.g = function(a, b, c, d) {
        if (null != d) {
            ...
            e = E("new-translation"),
            Ug(c, e),
            hf(E("new-translation"), !0),
            c = E("translate-page"),
            ie(a, Gh("MSG_OPEN_IN_TRANSLATE")),
            c.className = "gtx-a",
            e = Pc(Nl),
            c.style.cssText = zb(e),
            hf(a, !0)) : (a = de(document, "a"),
            a.id = "off",
            a.className = "gtx-a",
            a.setAttribute("target", "_blank"),
            ie(a, Gh("MSG_FOOTER_OPTIONS").toUpperCase()),
            ug(a, Tc(chrome.runtime.getURL("options.html"))),
            ee(c, a),
            a = de(document, "a"),
            a.id = "more",
            ...
            ug(a, Tc(e)),
            e = Pc(Ol),
            a.style.cssText = zb(e),
            ee(c, a))
        } else
            ie(E("translation"), Gh("MSG_TRANSLATION_ERROR"))
    }
    ;
    ...
    var Sl = function(a, b, c) {
        if (b) {
            ...
            Cf(b, "checked", null == c ? "mixed" : 1 == c ? "true" : "false"))
        }
    };
    ...
    k.bc = function(a) {
        ...
        this.isEnabled() && !a.target.href && I(this, b) && (a.s(),
        this.Ob(this.F ? !1 : !0),
        I(this, "change"))
    }
    ;
    k.ab = function(a) {
        32 == a.keyCode && (this.Sa(a),
        this.bc(a));
        return !1
    }
    ;
