...
So, I delayed it for later. But there is another way to install it on chrome. See the [Installation](#installation) process. 
...
## Uninstall
It is good practice to reset the extension from the extension's setting page before uninstalling the extension.
